...
| File | Description |
|---|---|
|:bar_chart: [`Bus_Breakdown_and_Delays_NYC_Project_Final.xlsx`](./Bus_Breakdown_and_Delays_NYC_Project_Final.xlsx) | Part 1 — Core analysis: Common Delay Reasons, How Delay Times Vary, Day of Week, Delay Burden |
